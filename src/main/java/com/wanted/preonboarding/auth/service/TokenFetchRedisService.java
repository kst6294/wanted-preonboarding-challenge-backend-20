...
@Service
public class TokenFetchRedisService extends AbstractRedisService implements TokenFetchService{

    public TokenFetchRedisService(StringRedisTemplate redisTemplate) {
        super(redisTemplate);
    }
