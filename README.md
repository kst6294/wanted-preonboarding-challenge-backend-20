...
<head>
  ...
  <title>Market-Service API 명세서</title>
  ...
  "properties" : {
    ...
    "password" : {
      ...
      "example" : "pwd"
            ...
            defs["QueryProductDetailsResponse"] = {
  "type" : "object",
  "properties" : {
    "productId" : {
      "type" : "integer",
  ...
  "properties" : {
    ...
    "createdAt" : {
      ...
      "format" : "date"
            ...
            defs["QueryTransactionDetailResponse"] = {
  "type" : "object",
  "properties" : {
    "transactionId" : {
      "type" : "integer",
    ...
    "status" : {
      "type" : "string"
            ...
            defs["QueryTransactionListResponse"] = {
  "type" : "object",
  "properties" : {
    "transactionId" : {
      "type" : "integer",
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="ProductAPI"><a href="#api-ProductAPI">API Methods - ProductAPI</a></li>
                    <li data-group="ProductAPI" data-name="createProduct" class="">
                      <a href="#api-ProductAPI-createProduct">createProduct</a>
                    </li>
                    <li data-group="ProductAPI" data-name="detail1" class="">
                      <a href="#api-ProductAPI-detail1">detail1</a>
                    </li>
                    <li data-group="ProductAPI" data-name="listProducts" class="">
                      <a href="#api-ProductAPI-listProducts">listProducts</a>
                    </li>
                  <li class="nav-header" data-group="TransactionAPI"><a href="#api-TransactionAPI">API Methods - TransactionAPI</a></li>
                    <li data-group="TransactionAPI" data-name="create" class="">
                      <a href="#api-TransactionAPI-create">create</a>
                    </li>
                    <li data-group="TransactionAPI" data-name="detail" class="">
                      <a href="#api-TransactionAPI-detail">detail</a>
                    </li>
                    <li data-group="TransactionAPI" data-name="listCompletion" class="">
                      <a href="#api-TransactionAPI-listCompletion">listCompletion</a>
                    </li>
                    <li data-group="TransactionAPI" data-name="listReservation" class="">
                      <a href="#api-TransactionAPI-listReservation">listReservation</a>
                    </li>
                  <li class="nav-header" data-group="UserAPI"><a href="#api-UserAPI">API Methods - UserAPI</a></li>
                    <li data-group="UserAPI" data-name="leaveUser" class="">
                      <a href="#api-UserAPI-leaveUser">leaveUser</a>
                    </li>
                    <li data-group="UserAPI" data-name="login" class="">
                      <a href="#api-UserAPI-login">login</a>
                    </li>
                    <li data-group="UserAPI" data-name="signup" class="">
                      <a href="#api-UserAPI-signup">signup</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>마켓 서비스 API 명세서</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-ProductAPI">
                  <h1>ProductAPI</h1>
                    <div id="api-ProductAPI-createProduct">
                      <article id="api-ProductAPI-createProduct-0" data-group="User" data-name="createProduct" data-version="0">
                        <div class="pull-left">
                          <h1>createProduct</h1>
                          <p>상품 등록</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">상품을 등록합니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/product/create</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ProductAPI-createProduct-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-java">Java</a></li>
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ProductAPI-createProduct-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ProductAPI-createProduct-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ProductAPI-createProduct-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ProductAPI-createProduct-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Content-Type: application/json"\
"http://localhost:8080/product/create"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ProductAPI-createProduct-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ProductAPIApi;

import java.io.File;
import java.util.*;

public class ProductAPIApiExample {

    public static void main(String[] args) {
        ApiClient defaultClient = Configuration.getDefaultApiClient();


        ProductAPIApi apiInstance = new ProductAPIApi();
        CreateProduct body = ; // CreateProduct | 
        try {
            apiInstance.createProduct(body);
        } catch (ApiException e) {
            System.err.println("Exception when calling ProductAPIApi#createProduct");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-ProductAPI-createProduct-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ProductAPIApi;
...
public class ProductAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ProductAPI-createProduct-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ProductAPI-createProduct-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
CreateProduct *body = ; // 

ProductAPIApi *apiInstance = [[ProductAPIApi alloc] init];
...
[apiInstance createProductWith:body
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-ProductAPI-createProduct-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;


var api = new MarketServiceApi_.ProductAPIApi()
...
api.createProduct(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ProductAPI-createProduct-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ProductAPI-createProduct-0-csharp">
...
namespace Example
{
    public class createProductExample
    {
        public void main()
        {
            ...
            var body = new CreateProduct(); // CreateProduct | 
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductAPIApi.createProduct: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-ProductAPI-createProduct-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');


$api_instance = new Swagger\Client\ApiProductAPIApi();
$body = ; // CreateProduct | 

try {
    $api_instance->createProduct($body);
} catch (Exception $e) {
    echo 'Exception when calling ProductAPIApi->createProduct: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-ProductAPI-createProduct-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ProductAPIApi;


my $api_instance = WWW::SwaggerClient::ProductAPIApi->new();
my $body = WWW::SwaggerClient::Object::CreateProduct->new(); # CreateProduct | 

eval { 
    $api_instance->createProduct(body => $body);
};
if ($@) {
    warn "Exception when calling ProductAPIApi->createProduct: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-ProductAPI-createProduct-0-python">
...
api_instance = swagger_client.ProductAPIApi()
body =  # CreateProduct | 
...
try: 
    ...
    print("Exception when calling ProductAPIApi->createProduct: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                                  ...
                                  var result = $('#d2e199_createProduct_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_createProduct_body"></div>
                                </td>
                                </tr>
                            </table>
                      ...
                      <hr>
                    <div id="api-ProductAPI-detail1">
                      <article id="api-ProductAPI-detail1-0" data-group="User" data-name="detail1" data-version="0">
                        <div class="pull-left">
                          <h1>detail1</h1>
                          <p>상품 자세히 보기</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">상품을 자세하게 봅니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/product/detail/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ProductAPI-detail1-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ProductAPI-detail1-0-java">Java</a></li>
                          <li class=""><a href="#examples-ProductAPI-detail1-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ProductAPI-detail1-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ProductAPI-detail1-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ProductAPI-detail1-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ProductAPI-detail1-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ProductAPI-detail1-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ProductAPI-detail1-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ProductAPI-detail1-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ProductAPI-detail1-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ProductAPI-detail1-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Accept: */*"\
"http://localhost:8080/product/detail/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ProductAPI-detail1-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ProductAPIApi;
...
public class ProductAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        Long id = 789; // Long | 
        try {
            QueryProductDetailsResponse result = apiInstance.detail1(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ProductAPIApi#detail1");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-ProductAPI-detail1-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ProductAPIApi;
...
public class ProductAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ProductAPI-detail1-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ProductAPI-detail1-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
Long *id = 789; // 
...
// 상품 자세히 보기
[apiInstance detail1With:id
              completionHandler: ^(QueryProductDetailsResponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-ProductAPI-detail1-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.detail1(id, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-ProductAPI-detail1-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ProductAPI-detail1-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class detail1Example
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling ProductAPIApi.detail1: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-ProductAPI-detail1-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->detail1($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ProductAPIApi->detail1: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-ProductAPI-detail1-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ProductAPIApi;
...
eval { 
    my $result = $api_instance->detail1(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ProductAPIApi->detail1: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-ProductAPI-detail1-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # 상품 자세히 보기
    api_response = api_instance.detail1(id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ProductAPIApi->detail1: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-detail1-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-detail1-200-schema">
                                  <div id='responses-detail1-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "content" : {
    "*/*" : {
      "schema" : {
        "$ref" : "#/components/schemas/QueryProductDetailsResponse"
      }
    }
  }
};
                                        ...
                                        $('#responses-detail1-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-detail1-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-detail1-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-ProductAPI-listProducts">
                      <article id="api-ProductAPI-listProducts-0" data-group="User" data-name="listProducts" data-version="0">
                        <div class="pull-left">
                          <h1>listProducts</h1>
                          <p>상품 목록</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">상품 목록을 확인 할 수 있습니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/product/list</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-ProductAPI-listProducts-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-java">Java</a></li>
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-ProductAPI-listProducts-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-ProductAPI-listProducts-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-php">PHP</a></li>
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-ProductAPI-listProducts-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-ProductAPI-listProducts-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Accept: */*"\
"http://localhost:8080/product/list"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-ProductAPI-listProducts-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.ProductAPIApi;
...
public class ProductAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        ProductAPIApi apiInstance = new ProductAPIApi();
        try {
            array[QueryProductListResponse] result = apiInstance.listProducts();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ProductAPIApi#listProducts");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-ProductAPI-listProducts-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ProductAPIApi;
...
public class ProductAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-ProductAPI-listProducts-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-ProductAPI-listProducts-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
...
[apiInstance listProductsWithCompletionHandler: 
              ^(array[QueryProductListResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-ProductAPI-listProducts-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.listProducts(callback);
                            ...
                            <!--<div class="tab-pane" id="examples-ProductAPI-listProducts-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-ProductAPI-listProducts-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class listProductsExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling ProductAPIApi.listProducts: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-ProductAPI-listProducts-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    ...
    echo 'Exception when calling ProductAPIApi->listProducts: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-ProductAPI-listProducts-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::ProductAPIApi;
...
if ($@) {
    warn "Exception when calling ProductAPIApi->listProducts: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-ProductAPI-listProducts-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling ProductAPIApi->listProducts: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listProducts-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listProducts-200-schema">
                                  <div id='responses-listProducts-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
    ...
    "*/*" : {
      "schema" : {
        ...
        "x-content-type" : "*/*"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listProducts-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listProducts-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listProducts-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-TransactionAPI">
                  <h1>TransactionAPI</h1>
                    <div id="api-TransactionAPI-create">
                      <article id="api-TransactionAPI-create-0" data-group="User" data-name="create" data-version="0">
                        <div class="pull-left">
                          <h1>create</h1>
                          <p>거래 등록</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">거래를 등록합니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/transaction/create/{product_id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TransactionAPI-create-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-create-0-java">Java</a></li>
                          <li class=""><a href="#examples-TransactionAPI-create-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-create-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-create-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TransactionAPI-create-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-create-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-create-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TransactionAPI-create-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TransactionAPI-create-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-create-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TransactionAPI-create-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
 -H "Authorization: Bearer [[accessToken]]"\
"http://localhost:8080/transaction/create/{product_id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TransactionAPI-create-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TransactionAPIApi;

import java.io.File;
import java.util.*;

public class TransactionAPIApiExample {

    public static void main(String[] args) {
        ApiClient defaultClient = Configuration.getDefaultApiClient();


        TransactionAPIApi apiInstance = new TransactionAPIApi();
        Long productId = 789; // Long | 
        try {
            apiInstance.create(productId);
        } catch (ApiException e) {
            System.err.println("Exception when calling TransactionAPIApi#create");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TransactionAPI-create-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TransactionAPI-create-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TransactionAPI-create-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
Long *productId = 789; // 

TransactionAPIApi *apiInstance = [[TransactionAPIApi alloc] init];

// 거래 등록
[apiInstance createWith:productId
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-create-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;


var api = new MarketServiceApi_.TransactionAPIApi()
...
api.create(productId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TransactionAPI-create-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TransactionAPI-create-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class createExample
    {
        public void main()
        {
            ...
            var apiInstance = new TransactionAPIApi();
            var productId = 789;  // Long | 
            ...
            {
                Debug.Print("Exception when calling TransactionAPIApi.create: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-create-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');


$api_instance = new Swagger\Client\ApiTransactionAPIApi();
$productId = 789; // Long | 

try {
    $api_instance->create($productId);
} catch (Exception $e) {
    echo 'Exception when calling TransactionAPIApi->create: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-create-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TransactionAPIApi;


my $api_instance = WWW::SwaggerClient::TransactionAPIApi->new();
my $productId = 789; # Long | 

eval { 
    $api_instance->create(productId => $productId);
};
if ($@) {
    warn "Exception when calling TransactionAPIApi->create: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-create-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
# create an instance of the API class
api_instance = swagger_client.TransactionAPIApi()
productId = 789 # Long | 
...
try: 
    ...
    print("Exception when calling TransactionAPIApi->create: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">product_id*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_create_productId">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Long
                      ...
                      <hr>
                    <div id="api-TransactionAPI-detail">
                      <article id="api-TransactionAPI-detail-0" data-group="User" data-name="detail" data-version="0">
                        <div class="pull-left">
                          <h1>detail</h1>
                          <p>거래내역 조회</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">용품에 대한 (판매자/구매자)라면 거래내역을 볼 수 있습니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/transaction/detail/{product_id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TransactionAPI-detail-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-detail-0-java">Java</a></li>
                          <li class=""><a href="#examples-TransactionAPI-detail-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-detail-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-detail-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TransactionAPI-detail-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-detail-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-detail-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TransactionAPI-detail-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TransactionAPI-detail-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-detail-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TransactionAPI-detail-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Accept: */*"\
"http://localhost:8080/transaction/detail/{product_id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TransactionAPI-detail-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        Long productId = 789; // Long | 
        try {
            QueryTransactionDetailResponse result = apiInstance.detail(productId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TransactionAPIApi#detail");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TransactionAPI-detail-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TransactionAPI-detail-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TransactionAPI-detail-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
Long *productId = 789; // 
...
// 거래내역 조회
[apiInstance detailWith:productId
              completionHandler: ^(QueryTransactionDetailResponse output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-detail-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.detail(productId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TransactionAPI-detail-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TransactionAPI-detail-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class detailExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TransactionAPIApi.detail: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-detail-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->detail($productId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TransactionAPIApi->detail: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-detail-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TransactionAPIApi;
...
eval { 
    my $result = $api_instance->detail(productId => $productId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TransactionAPIApi->detail: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-detail-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # 거래내역 조회
    api_response = api_instance.detail(productId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TransactionAPIApi->detail: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_detail_productId">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Long
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-detail-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-detail-200-schema">
                                  <div id='responses-detail-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "content" : {
    "*/*" : {
      "schema" : {
        "$ref" : "#/components/schemas/QueryTransactionDetailResponse"
      }
    }
  }
};
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-detail-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-detail-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-detail-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-TransactionAPI-listCompletion">
                      <article id="api-TransactionAPI-listCompletion-0" data-group="User" data-name="listCompletion" data-version="0">
                        <div class="pull-left">
                          <h1>listCompletion</h1>
                          <p>구매 완료 리스트</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">자신의 구매한 용품을 볼 수 있습니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/transaction/list/completion</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TransactionAPI-listCompletion-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-java">Java</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-listCompletion-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-listCompletion-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listCompletion-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TransactionAPI-listCompletion-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Accept: */*"\
"http://localhost:8080/transaction/list/completion"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        TransactionAPIApi apiInstance = new TransactionAPIApi();
        try {
            array[QueryTransactionListResponse] result = apiInstance.listCompletion();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TransactionAPIApi#listCompletion");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

TransactionAPIApi *apiInstance = [[TransactionAPIApi alloc] init];

// 구매 완료 리스트
[apiInstance listCompletionWithCompletionHandler: 
              ^(array[QueryTransactionListResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.listCompletion(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class listCompletionExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TransactionAPIApi.listCompletion: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->listCompletion();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TransactionAPIApi->listCompletion: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TransactionAPIApi;
...
eval { 
    my $result = $api_instance->listCompletion();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TransactionAPIApi->listCompletion: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-listCompletion-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # 구매 완료 리스트
    api_response = api_instance.list_completion()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TransactionAPIApi->listCompletion: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listCompletion-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listCompletion-200-schema">
                                  <div id='responses-listCompletion-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "content" : {
    "*/*" : {
      "schema" : {
        "type" : "array",
        "items" : {
          "$ref" : "#/components/schemas/QueryTransactionListResponse"
        },
        "x-content-type" : "*/*"
      }
    }
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listCompletion-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listCompletion-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listCompletion-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-TransactionAPI-listReservation">
                      <article id="api-TransactionAPI-listReservation-0" data-group="User" data-name="listReservation" data-version="0">
                        <div class="pull-left">
                          <h1>listReservation</h1>
                          <p>예약 리스트</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">(판매자/구매자) 예약 용품을 볼 수 있습니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/transaction/list/reservation</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TransactionAPI-listReservation-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-java">Java</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-listReservation-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TransactionAPI-listReservation-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TransactionAPI-listReservation-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TransactionAPI-listReservation-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Accept: */*"\
"http://localhost:8080/transaction/list/reservation"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        TransactionAPIApi apiInstance = new TransactionAPIApi();
        try {
            array[QueryTransactionListResponse] result = apiInstance.listReservation();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TransactionAPIApi#listReservation");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TransactionAPIApi;
...
public class TransactionAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

TransactionAPIApi *apiInstance = [[TransactionAPIApi alloc] init];

// 예약 리스트
[apiInstance listReservationWithCompletionHandler: 
              ^(array[QueryTransactionListResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.listReservation(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TransactionAPI-listReservation-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class listReservationExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TransactionAPIApi.listReservation: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->listReservation();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TransactionAPIApi->listReservation: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TransactionAPIApi;
...
eval { 
    my $result = $api_instance->listReservation();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TransactionAPIApi->listReservation: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TransactionAPI-listReservation-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # 예약 리스트
    api_response = api_instance.list_reservation()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TransactionAPIApi->listReservation: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-listReservation-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-listReservation-200-schema">
                                  <div id='responses-listReservation-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
    ...
    "*/*" : {
      "schema" : {
        ...
        "x-content-type" : "*/*"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-listReservation-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-listReservation-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-listReservation-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-UserAPI">
                  <h1>UserAPI</h1>
                    <div id="api-UserAPI-leaveUser">
                      <article id="api-UserAPI-leaveUser-0" data-group="User" data-name="leaveUser" data-version="0">
                        <div class="pull-left">
                          <h1>leaveUser</h1>
                          <p>회원 탈퇴</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">사용자의 계정을 삭제합니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/user/leave</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-UserAPI-leaveUser-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-java">Java</a></li>
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-UserAPI-leaveUser-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-UserAPI-leaveUser-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-php">PHP</a></li>
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-UserAPI-leaveUser-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-UserAPI-leaveUser-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X DELETE\
 -H "Authorization: Bearer [[accessToken]]"\
"http://localhost:8080/user/leave"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-UserAPI-leaveUser-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
public class UserAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            apiInstance.leaveUser();
        } catch (ApiException e) {
            System.err.println("Exception when calling UserAPIApi#leaveUser");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-UserAPI-leaveUser-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.UserAPIApi;
...
public class UserAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-UserAPI-leaveUser-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-UserAPI-leaveUser-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];

UserAPIApi *apiInstance = [[UserAPIApi alloc] init];

// 회원 탈퇴
[apiInstance leaveUserWithCompletionHandler: 
              ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-UserAPI-leaveUser-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;


var api = new MarketServiceApi_.UserAPIApi()
var callback = function(error, data, response) {
  if (error) {
    console.error(error);
  } else {
...
api.leaveUser(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-UserAPI-leaveUser-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-UserAPI-leaveUser-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class leaveUserExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UserAPIApi.leaveUser: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-UserAPI-leaveUser-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $api_instance->leaveUser();
} catch (Exception $e) {
    echo 'Exception when calling UserAPIApi->leaveUser: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-UserAPI-leaveUser-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
if ($@) {
    warn "Exception when calling UserAPIApi->leaveUser: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-UserAPI-leaveUser-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # 회원 탈퇴
    api_instance.leave_user()
except ApiException as e:
    print("Exception when calling UserAPIApi->leaveUser: %s\n" % e)</code></pre>
                            </div>
                          </div>
                      ...
                      <hr>
                    <div id="api-UserAPI-login">
                      <article id="api-UserAPI-login-0" data-group="User" data-name="login" data-version="0">
                        <div class="pull-left">
                          <h1>login</h1>
                          <p>로그인</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">사용자의 계정에 로그인합니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/user/login</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-UserAPI-login-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-UserAPI-login-0-java">Java</a></li>
                          <li class=""><a href="#examples-UserAPI-login-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-UserAPI-login-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-UserAPI-login-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-UserAPI-login-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-UserAPI-login-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-UserAPI-login-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-UserAPI-login-0-php">PHP</a></li>
                          <li class=""><a href="#examples-UserAPI-login-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-UserAPI-login-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-UserAPI-login-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Accept: */*"\
-H "Content-Type: application/json"\
"http://localhost:8080/user/login"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-UserAPI-login-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.UserAPIApi;
...
public class UserAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling UserAPIApi#login");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-UserAPI-login-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.UserAPIApi;
...
public class UserAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-UserAPI-login-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-UserAPI-login-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
LoginRequest *body = ; // 
...
[apiInstance loginWith:body
              completionHandler: ^(TokenResponse output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-UserAPI-login-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.login(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-UserAPI-login-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-UserAPI-login-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class loginExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UserAPIApi.login: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-UserAPI-login-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-UserAPI-login-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::UserAPIApi;
...
if ($@) {
    warn "Exception when calling UserAPIApi->login: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-UserAPI-login-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling UserAPIApi->login: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-login-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-login-200-schema">
                                  <div id='responses-login-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
    ...
    "*/*" : {
      "schema" : {
        "$ref" : "#/components/schemas/TokenResponse"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-login-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-login-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-login-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-UserAPI-signup">
                      <article id="api-UserAPI-signup-0" data-group="User" data-name="signup" data-version="0">
                        <div class="pull-left">
                          <h1>signup</h1>
                          <p>회원가입</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">사용자를 등록합니다.</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/user/signup</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-UserAPI-signup-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-UserAPI-signup-0-java">Java</a></li>
                          <li class=""><a href="#examples-UserAPI-signup-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-UserAPI-signup-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-UserAPI-signup-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-UserAPI-signup-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-UserAPI-signup-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-UserAPI-signup-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-UserAPI-signup-0-php">PHP</a></li>
                          <li class=""><a href="#examples-UserAPI-signup-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-UserAPI-signup-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-UserAPI-signup-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
 -H "Authorization: Bearer [[accessToken]]"\
-H "Content-Type: application/json"\
"http://localhost:8080/user/signup"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-UserAPI-signup-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.UserAPIApi;
...
public class UserAPIApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling UserAPIApi#signup");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-UserAPI-signup-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.UserAPIApi;
...
public class UserAPIApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-UserAPI-signup-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-UserAPI-signup-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Configuration *apiConfig = [Configuration sharedConfig];
SignUpRequest *body = ; // 
...
[apiInstance signupWith:body
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-UserAPI-signup-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MarketServiceApi_ = require('market_service_api_');
var defaultClient = MarketServiceApi_.ApiClient.instance;
...
api.signup(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-UserAPI-signup-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-UserAPI-signup-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class signupExample
    {
        public void main()
        {
            ...
            var apiInstance = new UserAPIApi();
            var body = new SignUpRequest(); // SignUpRequest | 
            ...
            {
                Debug.Print("Exception when calling UserAPIApi.signup: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-UserAPI-signup-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    ...
    echo 'Exception when calling UserAPIApi->signup: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-UserAPI-signup-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::UserAPIApi;
...
my $api_instance = WWW::SwaggerClient::UserAPIApi->new();
my $body = WWW::SwaggerClient::Object::SignUpRequest->new(); # SignUpRequest | 

eval { 
    $api_instance->signup(body => $body);
};
if ($@) {
    warn "Exception when calling UserAPIApi->signup: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-UserAPI-signup-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling UserAPIApi->signup: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_signup_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_signup_body"></div>
                                </td>
                                </tr>
                            </table>
