...
public class OrderController {
    ...
    /* 제품 주문 */
    @PostMapping
    public OrderCreateDto.Response orderProduct(@RequestBody OrderCreateDto.Request request) {
        log.info("제품 주문 api");
    ...
    public OrderInfoDto approveProductOrder(@PathVariable Long orderId) {
        log.info("판매 승인 api");
