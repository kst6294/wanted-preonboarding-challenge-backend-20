...
public class GoodsService {
    ...
    private List<Orders> getTrades(Long buyerId, Goods goods) {
        ...
        return orderService.getOrderList(buyerId, goods.getSeller().getMemberId());
    }
    ...
    public Long orderGoods(Long memberId, Long goodsId, int quantity) {
        ...
        // 주문 서비스 레이어로 이동필요!
        // 주문
        Orders saveOrders = orderService.createdOrder(goods, buyer, quantity);
